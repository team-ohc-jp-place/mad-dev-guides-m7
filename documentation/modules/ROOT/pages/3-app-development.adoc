...
* *TEKTON* タブをクリックしてパイプライン情報を確認します。
...
* *KUBERNETES* をクリックしてOpenShift クラスター内のアプリケーションのステータスを確認します。
...
1. https://developer-hub-rhdhub.%SUBDOMAIN%/catalog/default/component/frontend-app-%USERID%[Red Hat Developer Hub UI^] 上のフロントエンドコンポーネントに戻ります。
...
* https://developer-hub-rhdhub.%SUBDOMAIN%/catalog/default/component/frontend-app-%USERID%[Red Hat Developer Hub の UI^] のフロントエンドコンポーネントに戻ります。
...
* The *Relations* セクションには namespace にインストールしたすべてのサービスが表示されます。
* The *APIs* セクションには、フロントエンド アプリケーションが製品カタログからインベントリまでバックエンドサービス情報にアクセスするために使用するゲートウェイ API が表示されます。
